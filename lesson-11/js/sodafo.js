...
const apiURL = "http://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=fb589240ce3f3e1712da9b7878c9228b&units=imperial";
    ...
    let mylist = weatherInfo.list;
                ...
                for (i=0;i<mylist.length;i++) {    //bien
                    ...
                    if (time.includes('18:00:00')) {    //bien
                                    ...
                                    let theDayName = document.createElement("span");   //bien
