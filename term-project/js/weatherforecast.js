...
const apiURL = "http://api.openweathermap.org/data/2.5/forecast?id=3699674&appid=fb589240ce3f3e1712da9b7878c9228b&units=imperial";
...
fetch(apiURL)
  ...
  .then((weatherInfo) => {
    ...
    document.getElementById('weathforecast').appendChild(theDay);  //bien
